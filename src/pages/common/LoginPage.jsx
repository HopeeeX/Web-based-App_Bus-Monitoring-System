        ...
        <div className="w-full h-screen flex">
            <div className="grid grid-cols-1 md:grid-cols-2 m-auto md:h-[550px] shadow-lg rounded-lg sm:max-w-[900px] sm:h-[420px]">
                ...
                <div className="bg-primary flex flex-col justify-center shadow-lg rounded-lg p-5">
                    ...
                    <input className='border outline-none border-gray-300 rounded-lg h-10 w-72 pl-4 bg-transparent text-white font-inter' type='text' id='username' placeholder='Enter your username'/>
                ...
                <div className='flex flex-col items-start sm:m-2 md:ml-7'>
                    ...
                    <div className='relative'>
                    <input className='border outline-none border-gray-300 rounded-lg h-10 w-72 pl-4 bg-transparent text-white font-inter' type={isPasswordVisible ? 'text': 'password'} id='password' placeholder='Enter your password'/>
